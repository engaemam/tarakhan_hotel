...
<head>
    ...
    <title>Hotel room booking - Tarakhan</title>
...
<body>
    ...
    <div class="image-container set-full-height" style="background-image: url('http://demos.creative-tim.com/material-bootstrap-wizard/assets/img/wizard-book.jpg')">
	    ...
	    <a href="http://facebook.com/tarakhan-hotel-273513029934914" target="_blank">
		                        ...
		                        <div class="tab-content">
		                            	...
		                            	<div class="row">
		                                	...
		                                	<div class="col-sm-6">
		                                    	<div class="form-group label-floating">
                                                  ...
                                                  <div class="form-group label-floating">
                                                    <label class="control-label">Check <output></output></label>
		                            ...
		                            <div class="tab-pane" id="captain">
		                                <h4 class="info-text">What type of room would you want? </h4>
                                            ...
                                            <div class="form-group label-floating">
                                                <select class="form-control" name ="roomtype" id="exampleFormControlSelect1">
                                              ...
                                              <select class="form-control" name ="room_no" id="exampleFormControlSelect2">
                                                  @foreach ($roomarray as $data)                                       
                                                  <option name="room_no" value="{{ $data->room_no }}"  > {{ $data->room_no }}</option>                                                      
                                                   @endforeach
                                              </select>
                                        </div>
		                                    </div>
	                        	...
	                        	<div class="wizard-footer">
	                            	<div class="pull-right">
                                      ...
                                      <button type="submit" class="btn btn-primary">Create</button>
                                        <a href="/restable" class="btn btn-success ">Reservations</a>
	                                </div>
	                                <div class="pull-left">
	                                    <
	    ...
	    <div class="footer">
	        <div class="container text-center">
	             Made with <i class="fa fa-heart heart"></i> by <a href="http://facebook.com/tarakhan-hotel-273513029934914" target="_blank">Ahmad Emam</a>.
	        </div>
	    </div>
	</div>
</body>
